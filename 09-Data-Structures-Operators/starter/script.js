...
const weekdays = ['mon', 'tue', 'wed', 'thi', 'fri', 'sat', 'sun'];
const openingHours = {
  [weekdays[3]]: {
    open: 12,
    close: 22,
...
console.log('Jonas Shmedtmann'.split(' '));
...
capitalizeName('dmytro hrishylo');
...
console.log(maskCreditCard(634523231));
console.log(maskCreditCard(124562473456324));
console.log(maskCreditCard('43765965464353242325'));
...
// 2
let sumOdd = 0;
const oddsPropertyValues = Object.values(game.odds);
for (const x of oddsPropertyValues) {
    sumOdd += x;
}
const oddsProperty = Object.entries(game.odds)
const avrOdd = sumOdd / oddsProperty.length;
console.log(`Average odds: ${avrOdd}`);
