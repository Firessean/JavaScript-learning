...
eating too much or too little. Eating too much means the dog's current food portion is larger than the
recommended portion, and eating too little is the opposite. Eating an okay amount means the dog's current food
portion is within a range 10% above and 10% below the recommended portion (see hint).

  Your tasks:
1. Loop over the 'dogs' array containing dog objects, and for each dog, calculate
the recommended food portion and add it to the object as a new property. Do not create a new array, simply loop
over the array. Formula: recommendedFood = weight ** 0.75 * 28.
...
current > (recommended * 0.90) && current < (recommended * 1.10). Basically, the current portion should be
...
const calcEating = function (dogs) {
  dogs.forEach(dog => {
    const dogOwners = dog.owners.join(' and ');
    // Eating OK
    if (
      dog.curFood > dog.recommendedFood * 0.9 &&
      dog.curFood < dog.recommendedFood * 1.1
    )
      return console.log(`${dogOwners}'s dog eating OK!`);
    // Eating too much
    if (dog.curFood > dog.recommendedFood * 1.1)
      return console.log(`${dogOwners}'s dog eating too much!`);
    // Eating to little
    if (dog.curFood < dog.recommendedFood * 0.9)
      return console.log(`${dogOwners}'s dog eating to little!`);
  });
};
...
const ownersEatTooMuch = dogs
  .filter(dog => {
    if (dog.curFood > dog.recommendedFood * 1.1) return dog;
  })
...
const ownersEatTooLittle = dogs
  .filter(dog => {
    if (dog.curFood < dog.recommendedFood * 0.9) return dog;
  })
  .map(dog => dog.owners.join(' and '));
...
const dogsEatRecommended = dogs.some(
  dog => dog.curFood === dog.recommendedFood
);
console.log(dogsEatRecommended);

const dogsEatOk = dogs.some(
  dog =>
    dog.curFood > dog.recommendedFood * 0.9 &&
    dog.curFood < dog.recommendedFood * 1.1
);
...
const dogsEatOkArr = dogs.filter(
  dog =>
    dog.curFood > dog.recommendedFood * 0.9 &&
    dog.curFood < dog.recommendedFood * 1.1
);
