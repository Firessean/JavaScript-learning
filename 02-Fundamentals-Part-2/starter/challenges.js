...
// Test #1
let scoreOfDolphins = calcAverage(44, 23, 71);
let scoreOfKoalas = calcAverage(65, 54, 49);

const checkWinner = function (averageOfDolphins, averageOfKoalas) {

    if (averageOfDolphins >= 2 * averageOfKoalas) {
        console.log(`Dolphins is a WINNER!!! (${scoreOfDolphins} VS. ${scoreOfKoalas}) 🏆`);
    } else if (averageOfKoalas >= 2 * averageOfDolphins) {
        console.log(`Koalas is a WINNER!!! (${scoreOfKoalas} VS. ${scoreOfDolphins}) 🏆`);
    } else {
...
// Test #2
scoreOfDolphins = calcAverage(85, 54, 41);
scoreOfKoalas = calcAverage(23, 34, 27);
...
console.log(markMiller.calcBMI() > johnSmith.calcBMI() ? `${markMiller.fullName}'s BMI (${markMiller.bmi}) is higher than ${johnSmith.fullName} (${johnSmith.bmi})!` :
